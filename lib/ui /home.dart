  ...
  Widget build(BuildContext context) {
    return Scaffold(
       ...
       body: ListView.builder(
        itemCount: movieList.length,// changed the length since list changed
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Flexible(child: Text(movie.title,style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 17.0),)),
                      Text( "Rating: ${movie.imdRating}/10", style: mainTextStyle()),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
